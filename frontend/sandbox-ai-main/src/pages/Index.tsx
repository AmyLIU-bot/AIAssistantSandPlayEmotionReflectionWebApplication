...
const Index = () => {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      {/* ===== CONTENT SECTION ===== */}
      <section ref={contentRef} className="relative z-10 min-h-screen flex flex-col">
        {/* Logo */}
        ...
        {/* Content grid */}
        <div className="flex-1 px-6 md:px-12 lg:px-20 py-8 lg:py-10">
          <div className="w-full max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-[3fr_2fr] gap-10 lg:gap-14 items-stretch">
            {/* Left side */}
            <div className="space-y-8 pt-2 relative">
              <div className="absolute -inset-6 -z-10 rounded-3xl backdrop-blur-sm" style={{ background: 'linear-gradient(135deg, hsl(140 20% 97% / 0.45), hsl(140 20% 97% / 0.25))' }} />
              ...
              <div className="space-y-5">
                ...
                <p className="animate-fade-in-up animation-delay-200 text-lg leading-relaxed max-w-lg" style={{ color: 'hsl(150 8% 25%)' }}>
                ...
                <p className="animate-fade-in-up animation-delay-300 text-lg leading-relaxed max-w-lg" style={{ color: 'hsl(150 8% 25%)' }}>
                  The system then reflects their emotions in a gentle and meaningful way.
                </p>
              </div>

              {/* Decorative dots */}
              <div className="animate-fade-in-up animation-delay-400 flex gap-2 pt-2">
              ...
              <div className="animate-fade-in-up animation-delay-400 mt-8 rounded-2xl border border-border/50 bg-card/40 backdrop-blur-sm overflow-hidden aspect-video flex items-center justify-center">
            ...
            {/* Right side - Login card aligned with title */}
            <div className="animate-fade-in-up animation-delay-200 pt-2 flex flex-col">
              <Card className="shadow-card border-0 backdrop-blur-sm bg-card/90 transition-shadow duration-300 hover:shadow-card-hover flex-1 flex flex-col">
                ...
                <CardContent className="space-y-5 flex-1 flex flex-col justify-between">
                  ...
                  <Button variant="google" className="w-full h-11 text-base font-medium rounded-lg gap-3">
                  ...
                  <p className="text-center text-sm text-muted-foreground pt-2">
                    ...
                    <button className="text-primary font-semibold hover:underline underline-offset-2 transition-all duration-200">
                      Sign up
                    </button>
                  </p>
                </CardContent>
